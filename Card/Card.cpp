...
Card::Card(bool selected, int id, float x, float y, std::string Name, std::string Description,
    ...
    atkRadius(atkRadius), detectRadius(detectRadius), count(count), cost(cost), selected(selected) {
...
Card::Card(bool selected, int id, float x, float y, std::string Name, std::string Description, int pt, float radius, float duration, float interval, int atkTower): 
    ...
    pt(pt), radius(radius), duration(duration), interval(interval), atkTower(atkTower), selected(selected) {
